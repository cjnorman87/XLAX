...
class JobsInfoFooterCell : UICollectionViewCell {
    ...
    func setupApplyButton() {
        ...
        applyButton.anchor(top: nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 25, paddingBottom: -15, paddingRight: -25, width: 0, height: 50)
