...
class JobsCell : UICollectionViewCell {
    ...
    let postingTitle : UILabel = {
        ...
        label.font = UIFont(name: "SFProRounded-Bold", size: 14)
...
//        label.text = "Programmer"
    ...
    let latestTimePosting : UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = UIFont(name: "SFProRounded-Light", size: 14)
        label.textColor = UIColor(white: 0.5, alpha: 0.8)
    ...
    func setupCompanyName() {
        ...
        companyName.anchor(top: postingTitle.topAnchor, bottom: nil, right: nil, left: postingTitle.leftAnchor, paddingTop: 15, paddingBottom: 0, paddingRight: 0, paddingLeft: 0, height: 0, width: 0)
    }
    
    func setupSalaryTitle() {
        addSubview(salaryLabel)
        salaryLabel.anchor(top: companyName.topAnchor, bottom: nil, right: nil, left: companyName.leftAnchor, paddingTop: 15, paddingBottom: 0, paddingRight: 0, paddingLeft: 0, height: 0, width: 0)
    }
